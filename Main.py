...
while True:
    ...
    if opcion == 1:
        ...
        punto_a = np.array([float(punto_txt_a[0]), float(punto_txt_a[1]), float(punto_txt_a[2])])
        punto_txt_b = punto_b.split(",")
        punto_b = np.array([float(punto_txt_b[0]), float(punto_txt_b[1]), float(punto_txt_b[2])])
        ...
        vector_a = np.array([float(vector_txt_a[0]), float(vector_txt_a[1]), float(vector_txt_a[2])])
        vector_txt_b = vector_b.split(",")
        vector_b = np.array([float(vector_txt_b[0]), float(vector_txt_b[1]), float(vector_txt_b[2])])
